...
def chunk_hierarchical(text: str, parent_size: int = HIERARCHICAL_PARENT_SIZE,
    ...
    for parent in parents:
        ...
        ptext = parent.text
        for i in range(0, len(ptext), child_size):
            child_text = ptext[i:i + child_size].strip()
            if child_text:
    ...
    def flush():
        ...
        if current_header or content:
            ...
            if full_text:
                ...
                chunks.append(Chunk(text=full_text, metadata={**metadata, "section": section, "strategy": "structure"}))
